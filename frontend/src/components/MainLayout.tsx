...
const MainLayout: React.FC<MainLayoutProps> = ({ children, profile = 'empregador', userName = 'Maria', avatarUrl, title }) => {
  ...
  const handleContextChange = () => {
    ...
    if (typeof window !== 'undefined' && (window as any).forceShowContextModal) {
      (window as any).forceShowContextModal()
    }
  }
